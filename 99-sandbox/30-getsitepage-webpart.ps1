...
$page = GraphAPI $env:GRAPH_ACCESSTOKEN "GET" "https://graph.microsoft.com/beta/sites/$siteId/pages/$pageId/microsoft.graph.sitePage/webParts"

$result = join-path $workdir $pageId "pages-webparts.json"
