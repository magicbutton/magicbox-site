...
title: Get Site
connection: graph
output: pages-verticalsections.json
---#>
...
$page = GraphAPI $env:GRAPH_ACCESSTOKEN "GET" "https://graph.microsoft.com/beta/sites/$siteId/pages/$pageId/microsoft.graph.sitePage/canvasLayout/verticalSection"

$result = join-path $workdir $pageId  "pages-verticalsections.json"
