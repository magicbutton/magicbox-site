...
func DownloadSitePagesPost(ctx context.Context, args []string) (*schemas.Pages, error) {

	result, pwsherr := execution.ExecutePowerShell("john", "*", "magicbox-site", "20-download", "20-getsitepages.ps1", "", "-siteUrl", args[0])
	if pwsherr != nil {
		return nil, pwsherr
	}
